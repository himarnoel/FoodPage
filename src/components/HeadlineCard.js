  ...
  return (
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
        ...
        <div className='rounded-xl relative'>
            {/* overlay */}
            <div className='absolute w-full h-full text-white rounded-xl  bg-black/50'>
                <p className='font-bold text-2xl px-2 pt-4'> Sun's Out, BOGO's Out</p>
                <p className='px-2'>Through 8/26</p>
                <button className=' border border-white bg-white text-black rounded-xl mx-2 absolute  bottom-4 py-1 px-5'>Order now</button>
            </div>
            <img
        ...
        />
            ...
            {/* overlay */}
            <div className='absolute w-full h-full text-white rounded-xl  bg-black/50'>
                <p className='font-bold text-2xl px-2 pt-4'>We Delivery Dessert Too</p>
